...
async function main() {
  ...
  if (fs.readdirSync(`${basePath}/build/images`).length > 0){
    ...
    for (const file of files) {
      ...
      console.log(`${response.file_name} uploaded & ${fileName}.json Created!`);
    ...
    fs.writeFileSync(
     ...
     console.log("there is no Images..! put your NFT image inside build/images folder and retry again (: ")
  }
}
